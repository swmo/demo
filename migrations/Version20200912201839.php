 ...
 */
final class Version20200912201839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, starttime DATETIME NOT NULL, endtime DATETIME NOT NULL)');
