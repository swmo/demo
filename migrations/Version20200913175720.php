 ...
 */
final class Version20200913175720 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE resource_organisation_unit (resource_id INTEGER NOT NULL, organisation_unit_id INTEGER NOT NULL, PRIMARY KEY(resource_id, organisation_unit_id))');
        $this->addSql('CREATE INDEX IDX_CD2C21789329D25 ON resource_organisation_unit (resource_id)');
        $this->addSql('CREATE INDEX IDX_CD2C2179B39070E ON resource_organisation_unit (organisation_unit_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE resource_organisation_unit');
        $this->addSql('DROP INDEX IDX_2F585505BB70BC0E');
        $this->addSql('DROP INDEX IDX_2F58550550D813EA');
        $this->addSql('CREATE TEMPORARY TABLE __temp__dependency AS SELECT id, shift_id, resource_group_id, number FROM dependency');
        $this->addSql('DROP TABLE dependency');
